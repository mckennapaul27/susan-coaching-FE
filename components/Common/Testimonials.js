...
const Testimonials = () => {
    ...
    return (
        <div className="testimonials-area ptb-100" style={{
            ...
            <div className="container">
                ...
                >   
                    ...
                    <div className="single-testimonials-item">
                        ...
                        <p>Lorem ipsumsssss dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum  ultrices gravida. Risus commodo viverra maecenas accumsan lacus vel facilisis. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed tempor incididunt ut labore et dolore.</p>
                        <h3>David Warner</h3>
